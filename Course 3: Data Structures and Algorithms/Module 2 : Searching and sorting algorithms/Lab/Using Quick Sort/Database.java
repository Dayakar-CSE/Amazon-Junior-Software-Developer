...
public class Database {
    ...
    public void quickSort() {
        ...
        /* TODO 5: Initialize a pivot index variable with the value
            ...
            int pivotIndx = partition(highIndx, lowIndx);
    ...
    private int partition(int highIndx, int lowIndx) {
         ...
         */
        for(int current_Indx=0 ; current_Indx < subArray.size()-1;current_Indx++) {

            /* TODO 12: Get the element at the current index */
            Registration currentElement = (Registration) subArray.get(current_Indx);
        ...
        int pivotIndx = greaterThan_Indx+1;
